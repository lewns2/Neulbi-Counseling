	...
	<div class="bg-img">
		<div class="content">
			...
			<div class="links d-flex justify-content-evenly">
				<a class="social_btn" href="https://i6e202.p.ssafy.io:8443/oauth2/authorization/google?redirect_uri=http://localhost:8080/oauth/redirect" >
				...
				<a class="social_btn" href="https://i6e202.p.ssafy.io:8443/oauth2/authorization/naver?redirect_uri=http://localhost:8080/oauth/redirect">
				...
				<a class="social_btn" href="https://i6e202.p.ssafy.io:8443/oauth2/authorization/kakao?redirect_uri=http://localhost:8080/oauth/redirect">
