	...
	<div class="bg-img">
		<div class="content">
			...
			<div class="links d-flex justify-content-evenly">
				<a class="social_btn" :href="`${state.BACKEND_URL}/oauth2/authorization/google?redirect_uri=${state.REDIRECT_URI}`">
				...
				<a class="social_btn" :href="`${state.BACKEND_URL}/oauth2/authorization/naver?redirect_uri=${state.REDIRECT_URI}`">
				...
				<a class="social_btn" :href="`${state.BACKEND_URL}/oauth2/authorization/kakao?redirect_uri=${state.REDIRECT_URI}`">
